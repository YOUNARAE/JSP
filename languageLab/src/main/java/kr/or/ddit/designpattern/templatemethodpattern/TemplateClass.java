...
public abstract class TemplateClass { //단계를 정의하고 있는 템플릿 메서드
	// 템플릿 클래스에는 절대 바뀌지 않는 패턴 템플릿이 필요하다
	public final void template() { //순서를 정의하고 있는 메서드
		...
		stepTwo();
		stepThree();
		//위의 1,2,3 순서는 절대 바꿀 수 없다, 
	}
	
	// hook method 반복되는 것을 정의하고 있는 메서드.
