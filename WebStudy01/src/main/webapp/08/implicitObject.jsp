...
<h4>기본객체(내장객체)</h4>
<pre>
	request(HttpServletRequest) : 클라이언트과 그로부터 발생한 요청에 대한 정보를 캡슐화한 객체
	...
	pageContext(PageContext *****가장 중요함) : 현재  JSP 페이지에 대한 모든 정보를 캡슐화한 객체.el이 지원되는 유일한 객체
	ex ) ${ pageContenxt.request.contextPath }
