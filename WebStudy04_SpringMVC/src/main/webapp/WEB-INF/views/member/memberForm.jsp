...
<form:form modelAttribute="member" enctype="multipart/form-data">
	<table class="table table-bordered">
		...
		<tr>
			...
			<td>
<%-- 			<form:input path="memImage" type="file" /> --%>
		...
		<tr>
			...
			<td>
				<form:input path="memMemorial" cssClass="form-control" type="date" /> 
		...
		<tr>
			...
			<td>
				<form:input path="memMileage" cssClass="form-control" type="number"/> 
