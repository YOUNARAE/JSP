...
public class LoginProcessController {
	//서블릿 4.대는 생성자만 있으면 들어온다, 
	//스프링은 대부분의 빈을 싱글톤을 관리하기때문에 @RequiredArgsConstructor를 넣으면 바AuthuenticateService 생성자가 생성된다
	private final AuthuenticateService service;
